...
source(here::here("Code/process_pisa.R"))
```
...
```{r}
system(glue("Rscript {here('Code/2000/data_2000.R')}"))
...
clean_2000 = transform_pisa_variables(
  target_year = 2000, 
  df = sch_2000, 
  mapping_csv_path = here::here("variable_curation/PISA_variable_curation_school.csv")
)
...
clean_2003 = transform_pisa_variables(
  target_year = 2003, 
  df = sch_2003, 
  mapping_csv_path = here::here("variable_curation/PISA_variable_curation_school.csv")
)
...
clean_2006 = transform_pisa_variables(
  target_year = 2006, 
  df = sch_2006, 
  mapping_csv_path = here::here("variable_curation/PISA_variable_curation_school.csv")
)
...
clean_2009 = transform_pisa_variables(
  target_year = 2009, 
  df = sch_2009, 
  mapping_csv_path = here::here("variable_curation/PISA_variable_curation_school.csv")
)
...
clean_2012 = transform_pisa_variables(
  target_year = 2012, 
  df = sch_2012, 
  mapping_csv_path = here::here("variable_curation/PISA_variable_curation_school.csv")
)
...
clean_2015 = transform_pisa_variables(
  target_year = 2015, 
  df = sch_2015, 
  mapping_csv_path = here::here("variable_curation/PISA_variable_curation_school.csv")
)
...
clean_2018 = transform_pisa_variables(
  target_year = 2018, 
  df = sch_2018, 
  mapping_csv_path = here::here("variable_curation/PISA_variable_curation_school.csv")
)
...
clean_2022 = transform_pisa_variables(
  target_year = 2022, 
  df = sch_2022, 
  mapping_csv_path = here::here("variable_curation/PISA_variable_curation_school.csv")
)
...
school <- list_data %>%
  ...
  dplyr::mutate(
    ...
    public_private = as.factor(public_private)) %>%  # Convert public_private back to factor
  as_tibble()
