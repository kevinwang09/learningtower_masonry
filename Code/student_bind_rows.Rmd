...
clean_2022 <- stu_2022 %>% 
  dplyr::transmute(
    ...
    escs = escs %>% as.numeric %>% na_if(95) %>% na_if(97) %>% na_if(98) %>% na_if(99),
    curiosity = curiosity %>% as.numeric %>% na_if(95) %>% na_if(97) %>% na_if(98) %>% na_if(99))
...
# Create subset data for 2022
student_2022 <- student |> 
  filter(year == "2022")
saveRDS(student_2022, file = here("Data/Output/student_2022.rds"))
```
